...
11. Do NOT end the hook with, or place near its end, any phrase that describes the SENDER'S search or reaction, because the very next line begins "I am looking to buy one company..." and the echo reads as clumsy repetition. Banned closings include: "looking for", "what I have been looking for", "set out to find", "the kind of business/company I am interested in", "the type of business I am interested in", "drew me to reach out", "caught my attention", "made me want to reach out", "the reason I wanted to connect", "draws me to a business", "gets my attention", "is exactly what I pay attention to". End instead on the merit of the company itself (for example "is not something that happens by accident", "is genuinely rare", "speaks for itself").
